...
export const XP_RULES: Record<ProgressionEventType, XpAward> = {
  ...
  // Shopify Dev Actions. Same VERIFY/SHIP split the rest of this table
  // already uses: a check or a build (cheap to run, cheap to satisfy) earns
  // less than a push or a deploy (an actual shipped outcome), and every
  // value here still sits below 'git-commit' - a Shopify deploy is a
  // meaningful outcome, not the single strongest signal this extension has.
  'shopify-theme-check-success': { trainerXp: 4, pokemonXp: 6 },
  'shopify-app-build-success': { trainerXp: 5, pokemonXp: 8 },
  'shopify-theme-push-success': { trainerXp: 6, pokemonXp: 10 },
  'shopify-extension-deploy-success': { trainerXp: 8, pokemonXp: 12 },
  'shopify-function-deploy-success': { trainerXp: 8, pokemonXp: 12 },
  'shopify-app-deploy-success': { trainerXp: 10, pokemonXp: 15 },
  'shopify-theme-publish-success': { trainerXp: 10, pokemonXp: 15 },
