...
import { getResolvedCrystalPalette } from './crystal-palette-config';
import { resolvePokeballSpriteUri } from './pokeball-service';
...
class PokedevState {
  ...
  public buildTrainerView(
    ...
    return {
      ...
      crystalPalette: getResolvedCrystalPalette(),
    };
  }
  ...
  public buildPartyEntries(
    ...
    return listPartnerCandidates(context).map((entry) => {
      ...
      return {
        ...
        friendship: progress.friendship,
        pokeballId: progress.pokeballId,
        pokeballSpriteUri: resolvePokeballSpriteUri(
          webview,
          context.extensionUri,
          progress.pokeballId,
        ),
